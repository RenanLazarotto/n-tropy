...
func (c ClockIn) Validate() error {
	return validation.ValidateStruct(&c,
		validation.Field(&c.StartHour, validation.Required.Error("não pode ser vazio")),
		validation.Field(&c.StartMinute, validation.Required.Error("não pode ser vazio")),
	)
}
...
func main() {
	...
	t.Row(bold("8:48"), fullTime.Format("15:04"))
	t.Row("8:30", halfTime.Format("15:04"))
	t.Row("8:00", shortTime.Format("15:04"))
